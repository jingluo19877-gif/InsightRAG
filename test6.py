...
# 假设评论数据在这个文件中
file_path = r"E:\毕业设计\cleaned_reviews_1\cleaned_reviews_1.txt"
output_file_path = r"E:\毕业设计\cleaned_reviews_2\filtered_reviews_1.txt"  # 新的文件路径
...
def filter_reviews_with_entities_and_relations(file_path, output_file_path):
    ...
    with open(file_path, "r", encoding="utf-8") as f:
        while True:
            batch_reviews = [f.readline().strip() for _ in range(50)]
            # 过滤掉空行
