...
def retrieve_metadata():
    ...
    vars2readme = {}
    try:
        with open("rag/__init__.py") as f:
        ...
        raise FileNotFoundError("Metadata file './rag/__init__.py' not found.")
...
def read_api_requirements():
    api_deps = []
    try:
        with open("rag/api/requirements.txt") as f:
...
setuptools.setup(
    ...
    entry_points={
        "console_scripts": [
            "rag-server=rag.api.lightrag_server:main [api]",
        ],
    },
)
