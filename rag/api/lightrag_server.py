...
from rag.api import __api_version__
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="API key for authentication. This protects rag server against unauthorized access",
    )
...
def create_app(args):
    ...
    if args.llm_binding == "lollms" or args.embedding_binding == "lollms":
        from rag.llm.lollms import lollms_model_complete, lollms_embed
    if args.llm_binding == "ollama" or args.embedding_binding == "ollama":
        from rag.llm.ollama import ollama_model_complete, ollama_embed
    if args.llm_binding == "openai" or args.embedding_binding == "openai":
        from rag.llm.openai import openai_complete_if_cache, openai_embed
    if args.llm_binding == "azure_openai" or args.embedding_binding == "azure_openai":
        from rag.llm.azure_openai import (
            azure_openai_complete_if_cache,
            azure_openai_embed,
        )
    if args.llm_binding_host == "openai-ollama" or args.embedding_binding == "ollama":
        from rag.llm.openai import openai_complete_if_cache
        from rag.llm.ollama import ollama_embed
